...
(() => {
  ...
  class ThreeDStage extends HTMLElement {
    ...
    async _boot() {
      ...
      // Procedural dark studio env: softbox strips + a green rim panel → real reflections on carbon/metal.
      {
        const env = new THREE.Scene();
        env.background = new THREE.Color(0x050706);
      ...
      this._key = key;
      scene.add(key);
      const fill = new THREE.DirectionalLight(0x00ff66, 0.9);
